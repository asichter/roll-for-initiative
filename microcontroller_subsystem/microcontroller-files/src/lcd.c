...
// A 11x9 large fantasy font
const unsigned short lrgfnt1[11][11]={
{0x000,0x000,0x000,0x000,0x000,0x000,0x000,0x000,0x000,0x000,0x000},/*" ",0*/
{0x038,0x074,0x0E6,0x0C6,0x0E6,0x0D6,0x0CE,0x0C6,0x0CE,0x05C,0x038},/*"0",16*/
{0x020,0x030,0x038,0x030,0x030,0x030,0x030,0x030,0x030,0x030,0x078},/*"1",17*/
{0x078,0x0CC,0x0C4,0x0C0,0x040,0x020,0x010,0x008,0x00C,0x0FC,0x07C},/*"2",18*/
{0x038,0x07C,0x0E2,0x0C0,0x040,0x070,0x0E0,0x0C0,0x0C6,0x04E,0x03C},/*"3",19*/
{0x060,0x070,0x068,0x064,0x062,0x063,0x1FF,0x0FF,0x060,0x060,0x060},/*"4",20*/
{0x0FE,0x006,0x006,0x036,0x07E,0x0E6,0x0C2,0x0C0,0x0C6,0x04E,0x03C},/*"5",21*/
{0x0F0,0x1C8,0x184,0x006,0x076,0x0EE,0x1C6,0x186,0x18E,0x09C,0x078},/*"6",22*/
{0x1F8,0x1FC,0x082,0x040,0x020,0x030,0x030,0x030,0x030,0x070,0x030},/*"7",23*/
{0x0F8,0x1C4,0x186,0x18E,0x09C,0x078,0x0E4,0x1C6,0x18E,0x09C,0x078},/*"8",24*/
{0x078,0x0E4,0x1C6,0x186,0x18E,0x19C,0x1F8,0x180,0x086,0x04E,0x03C},/*"9",25*/
};

// 7x6 small fantasy font
const unsigned char smlfnt1[15][7]={
{0x00,0x00,0x00,0x00,0x00,0x00,0x00},/*" ",0*/
{0x1E,0x33,0x3B,0x37,0x33,0x33,0x1E},/*"0",16*/
{0x0C,0x0E,0x0C,0x0C,0x0C,0x0C,0x1E},/*"1",17*/
{0x1E,0x33,0x31,0x18,0x0C,0x06,0x3F},/*"2",18*/
{0x1E,0x31,0x30,0x18,0x30,0x31,0x1E},/*"3",19*/
{0x18,0x1E,0x1A,0x19,0x3F,0x18,0x18},/*"4",20*/
{0x3F,0x03,0x03,0x1F,0x30,0x31,0x3E},/*"5",21*/
{0x1E,0x33,0x03,0x1F,0x33,0x33,0x1E},/*"6",22*/
{0x3F,0x30,0x18,0x0C,0x0C,0x0C,0x0C},/*"7",23*/
{0x1E,0x33,0x33,0x1E,0x33,0x33,0x1E},/*"8",24*/
{0x1E,0x33,0x33,0x3E,0x30,0x31,0x1E},/*"9",25*/
{0x1E,0x33,0x33,0x3F,0x33,0x33,0x33},/*"A",10*/
{0x1F,0x66,0x66,0x66,0x66,0x66,0x1F},/*"D",11*/
{0x00,0x0C,0x0C,0x3F,0x0C,0x0C,0x00},/*"+",12*/
{0x00,0x00,0x00,0x00,0x1E,0x00,0x00},/*"-",13*/
};
//===========================================================================
