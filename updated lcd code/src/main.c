...
//    while(i2c_write_flash_complete() != 1);
    ...
    // LCD SCREEN: x = 0:239 y = 0:319
    LCD_Init();
    LCD_Clear(WHITE);

//    LCD_DisplayUIBox(1);
    printchr(0,0,LGRAY, "000", 0, 8);
    printchr(0,0,LGRAY, "000", 1, 0);
    printchr(0,0,LGRAY, "000", 2, 0);
    printchr(0,0,LGRAYBLUE, "-", 3, 0);


//    LCD_DisplayUIBox();
//    LCD_DrawRectangle(239, 319, BLUE);
//    LCD_DrawRectangle(0, 0, 300, 318, RED);
//    LCD_FontTest();
